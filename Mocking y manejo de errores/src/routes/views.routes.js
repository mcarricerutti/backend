...
import { login, signUp, profile, products, errorLogin, errorSignUp, cart, resetPass, resetPassMailSent, resetPassError, newPass, aggProd } from "../controllers/views.controller.js";
...
viewsRouter.get('/agregarProd', customJWTPolicy(["ADMIN","PREMIUM"]), aggProd)
